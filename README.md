...
- **Player name** (welcome screen): up to **14** characters
...
- One **HUD** at the top of the playfield shows **Hamster Run**, **hearts**, **stage + goal** on one line, and the **goal meter**; no separate page header, visit counter, or in-page leaderboard — scores show on **Game over** only.
